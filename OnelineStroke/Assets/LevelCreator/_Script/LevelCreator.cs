...
public class LevelCreator : MonoBehaviour
{
    ...
    public void ExportLevel()
    {
        ...
        string path = string.Format("Assets/Resources/Package_{0}/level_{1}.json", packageNumber, levelNumber);
        ...
        if (!File.Exists(path))
        {
            ...
            if (!AssetDatabase.IsValidFolder(folderPath))
                AssetDatabase.CreateFolder("Assets/Resources", "Package_" + packageNumber);
